      ...
      return (
        <Container style={styles.container} contentContainerStyle={{
            ...
            <Header style={styles.header}>
                ...
                <Body>
                    <Title style={styles.headerText}>Trainings</Title>
                </Body>
                <Right />
            </Header>
            <Content>
                <Card>
                    <CardItem>
                        <Left>
                            <Body>
                                <Text>Mentor Version</Text>
                                <Text note>Owner: Omkar Muravne</Text>
                            </Body>
                        </Left>
                    </CardItem>
                    <CardItem cardBody>
                        <Image style={{resizeMode: 'contain',flex:1, width: Dimensions.get('window').width}} source={require('../assets/images/business/mentor_version.png')} />
                    </CardItem>
                    <CardItem>
                        <Left>
                            <Button transparent textStyle={{color: '#87838B'}}>
                            <Text>Contact: 9986406107</Text>
                            </Button>
                        </Left>
                    </CardItem>
                </Card>
